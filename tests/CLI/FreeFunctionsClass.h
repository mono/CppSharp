...
// The free function here will have a class generated for it. We must make the generated class name unique and different to the existing
// FreeFunctionsClass. We append the word "Helpers" to the generated class name to make it unique.
