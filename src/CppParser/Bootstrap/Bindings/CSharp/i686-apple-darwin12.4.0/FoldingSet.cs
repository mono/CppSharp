    ...
    namespace llvm
    {
        ...
        public unsafe abstract partial class FoldingSetImpl : IDisposable
        {
            ...
            public unsafe partial class Node : IDisposable
            {
                ...
                {
                    var ret = (Node.Internal*) Marshal.AllocHGlobal(4);
                    *ret = native;
                    return ret;
                }
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (FoldingSetImpl) _References[instance].Target;
            ...
            private static void _GetNodeProfile_0DelegateHook(global::System.IntPtr instance, global::System.IntPtr N, global::System.IntPtr ID)
            {
                ...
                target.GetNodeProfile(__result0, __result1);
            }
            ...
            private static bool _NodeEquals_0DelegateHook(global::System.IntPtr instance, global::System.IntPtr N, global::System.IntPtr ID, uint IDHash, global::System.IntPtr TempID)
            {
                ...
                var __ret = target.NodeEquals(__result0, __result1, IDHash, __result3);
                return __ret;
            }
            ...
            private static uint _ComputeNodeHash_0DelegateHook(global::System.IntPtr instance, global::System.IntPtr N, global::System.IntPtr TempID)
            {
                ...
                var __ret = target.ComputeNodeHash(__result0, __result1);
                return __ret;
            }
        ...
        public unsafe partial class FoldingSetNodeIDRef : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern void ctor_1(global::System.IntPtr instance, uint* D, uint S);
            ...
            {
                var ret = (FoldingSetNodeIDRef.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
            ...
            public FoldingSetNodeIDRef(ref uint D, uint S)
            {
                __Instance = Marshal.AllocHGlobal(8);
                __ownsNativeInstance = true;
                NativeToManagedMap[__Instance] = this;
        ...
        public unsafe partial class FoldingSetNodeID : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern void AddInteger_2(global::System.IntPtr instance, int I);

                [SuppressUnmanagedCodeSecurity]
                [DllImport("CppSharp", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
                    EntryPoint="_ZN4llvm16FoldingSetNodeID10AddIntegerEm")]
                internal static extern void AddInteger_3(global::System.IntPtr instance, uint I);
            ...
            {
                var ret = (FoldingSetNodeID.Internal*) Marshal.AllocHGlobal(140);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class FoldingSetIteratorImpl : IDisposable
        {
            ...
            {
                var ret = (FoldingSetIteratorImpl.Internal*) Marshal.AllocHGlobal(4);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class FoldingSetBucketIteratorImpl : IDisposable
        {
            ...
            {
                var ret = (FoldingSetBucketIteratorImpl.Internal*) Marshal.AllocHGlobal(4);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class FastFoldingSetNode : llvm.FoldingSetImpl.Node, IDisposable
        {
            ...
            {
                var ret = (FastFoldingSetNode.Internal*) Marshal.AllocHGlobal(144);
                *ret = native;
                return ret;
            }
        ...
        internal unsafe partial class FoldingSetImplInternal : llvm.FoldingSetImpl, IDisposable
        {
            ...
            {
                var ret = (FoldingSetImpl.Internal*) Marshal.AllocHGlobal(16);
                *ret = native;
                return ret;
            }
            ...
            {
                void* slot = *(void**) (((FoldingSetImpl.Internal*) __Instance)->vfptr0 + 2 * 4);
            ...
            {
                void* slot = *(void**) (((FoldingSetImpl.Internal*) __Instance)->vfptr0 + 3 * 4);
            ...
            {
                void* slot = *(void**) (((FoldingSetImpl.Internal*) __Instance)->vfptr0 + 4 * 4);
