...
namespace CppSharp
{
    ...
    namespace clang
    {
        ...
        public unsafe partial class FixItHint : IDisposable
        {
            ...
            {
                var ret = (FixItHint.Internal*) Marshal.AllocHGlobal(40);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class DiagnosticsEngine : IDisposable
        {
            ...
            {
                var ret = (DiagnosticsEngine.Internal*) Marshal.AllocHGlobal(784);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class DiagnosticErrorTrap : IDisposable
        {
            ...
            {
                var ret = (DiagnosticErrorTrap.Internal*) Marshal.AllocHGlobal(12);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class DiagnosticBuilder : IDisposable
        {
            ...
            {
                var ret = (DiagnosticBuilder.Internal*) Marshal.AllocHGlobal(12);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class AddFlagValue : IDisposable
        {
            ...
            {
                var ret = (AddFlagValue.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class Diagnostic : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern int getRawArg_0(global::System.IntPtr instance, uint Idx);
            ...
            {
                var ret = (Diagnostic.Internal*) Marshal.AllocHGlobal(12);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class StoredDiagnostic : IDisposable
        {
            ...
            {
                var ret = (StoredDiagnostic.Internal*) Marshal.AllocHGlobal(52);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class DiagnosticConsumer : IDisposable
        {
            ...
            {
                var ret = (DiagnosticConsumer.Internal*) Marshal.AllocHGlobal(12);
                *ret = native;
                return ret;
            }
            ...
            private static void _clear_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (DiagnosticConsumer) _References[instance].Target;
                target.clear();
            }
            ...
            private static bool _IncludeInDiagnosticCounts_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (DiagnosticConsumer) _References[instance].Target;
                var __ret = target.IncludeInDiagnosticCounts();
                return __ret;
            }
            ...
            private static void _HandleDiagnostic_0DelegateHook(global::System.IntPtr instance, clang.DiagnosticsEngine.Level DiagLevel, global::System.IntPtr Info)
            {
                ...
                target.HandleDiagnostic(DiagLevel, __result1);
            }
        ...
        public unsafe partial class IgnoringDiagConsumer : clang.DiagnosticConsumer, IDisposable
        {
            ...
            {
                var ret = (IgnoringDiagConsumer.Internal*) Marshal.AllocHGlobal(12);
                *ret = native;
                return ret;
            }
            ...
            private static void _clear_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (IgnoringDiagConsumer) _References[instance].Target;
                target.clear();
            }
        ...
        public unsafe partial class ForwardingDiagnosticConsumer : clang.DiagnosticConsumer, IDisposable
        {
            ...
            {
                var ret = (ForwardingDiagnosticConsumer.Internal*) Marshal.AllocHGlobal(16);
                *ret = native;
                return ret;
            }
            ...
            private static void _clear_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (ForwardingDiagnosticConsumer) _References[instance].Target;
                target.clear();
            }
        ...
        public unsafe partial class TemplateDiffTypes : IDisposable
        {
            ...
            {
                var ret = (TemplateDiffTypes.Internal*) Marshal.AllocHGlobal(12);
                *ret = native;
                return ret;
            }
