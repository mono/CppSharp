    ...
    namespace llvm
    {
        ...
        public unsafe abstract partial class PrettyStackTraceEntry : IDisposable
        {
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (PrettyStackTraceEntry) _References[instance].Target;
        ...
        public unsafe partial class PrettyStackTraceString : llvm.PrettyStackTraceEntry, IDisposable
        {
            ...
            {
                var ret = (PrettyStackTraceString.Internal*) Marshal.AllocHGlobal(12);
                *ret = native;
                return ret;
            }
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (PrettyStackTraceString) _References[instance].Target;
                target.DestroyNativeInstance();
            }
        ...
        public unsafe partial class PrettyStackTraceProgram : llvm.PrettyStackTraceEntry, IDisposable
        {
            ...
            {
                var ret = (PrettyStackTraceProgram.Internal*) Marshal.AllocHGlobal(16);
                *ret = native;
                return ret;
            }
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (PrettyStackTraceProgram) _References[instance].Target;
                target.DestroyNativeInstance();
            }
        ...
        internal unsafe partial class PrettyStackTraceEntryInternal : llvm.PrettyStackTraceEntry, IDisposable
        {
            ...
            {
                var ret = (PrettyStackTraceEntry.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
            ...
            public override void print(llvm.raw_ostream OS)
            {
                void* slot = *(void**) (((PrettyStackTraceEntry.Internal*) __Instance)->vfptr0 + 2 * 4);
