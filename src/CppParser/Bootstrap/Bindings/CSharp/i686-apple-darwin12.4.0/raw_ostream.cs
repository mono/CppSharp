    ...
    namespace llvm
    {
        ...
        public unsafe abstract partial class raw_ostream : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern void SetBufferSize_0(global::System.IntPtr instance, uint Size);
                ...
                internal static extern uint GetNumBytesInBuffer_0(global::System.IntPtr instance);
                ...
                internal static extern global::System.IntPtr write_1(global::System.IntPtr instance, global::System.IntPtr Ptr, uint Size);
                ...
                internal static extern void SetBuffer_0(global::System.IntPtr instance, sbyte* BufferStart, uint Size);

                [SuppressUnmanagedCodeSecurity]
                [DllImport("CppSharp", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
                    EntryPoint="_ZNK4llvm11raw_ostream21preferred_buffer_sizeEv")]
                internal static extern uint preferred_buffer_size_0(global::System.IntPtr instance);
            ...
            public uint GetNumBytesInBuffer()
            {
            ...
            public llvm.raw_ostream write(string Ptr, uint Size)
            {
            ...
            /// <para>  /// flush.</para>
            /// </remarks>
            protected void SetBuffer(sbyte* BufferStart, uint Size)
            {
            ...
            /// </remarks>
            protected virtual uint preferred_buffer_size()
            {
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (raw_ostream) _References[instance].Target;
            ...
            private static global::System.IntPtr _changeColor_0DelegateHook(global::System.IntPtr instance, llvm.raw_ostream.Colors Color, bool Bold, bool BG)
            {
                ...
                var target = (raw_ostream) _References[instance].Target;
                var __ret = target.changeColor(Color, Bold, BG);
            ...
            [SuppressUnmanagedCodeSecurity]
            [UnmanagedFunctionPointerAttribute(global::System.Runtime.InteropServices.CallingConvention.Cdecl)]
            internal delegate uint _preferred_buffer_size_0Delegate(global::System.IntPtr instance);
            private static _preferred_buffer_size_0Delegate _preferred_buffer_size_0DelegateInstance;

            private static uint _preferred_buffer_size_0DelegateHook(global::System.IntPtr instance)
            {
                if (!_References.ContainsKey(instance))
                    throw new global::System.Exception("No managed instance was found");

                var target = (raw_ostream) _References[instance].Target;
                var __ret = target.preferred_buffer_size();
                return __ret;
            }
        ...
        public unsafe partial class raw_fd_ostream : llvm.raw_ostream, IDisposable
        {
            ...
            {
                var ret = (raw_fd_ostream.Internal*) Marshal.AllocHGlobal(36);
                *ret = native;
                return ret;
            }
            ...
            /// size.</para>
            /// </remarks>
            protected sealed override uint preferred_buffer_size()
            {
                var __ret = Internal.preferred_buffer_size_0(__Instance);
                return __ret;
            }
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (raw_fd_ostream) _References[instance].Target;
                target.DestroyNativeInstance();
            }
            ...
            private static global::System.IntPtr _changeColor_0DelegateHook(global::System.IntPtr instance, llvm.raw_ostream.Colors colors, bool bold, bool bg)
            {
                ...
                var target = (raw_fd_ostream) _References[instance].Target;
                var __ret = target.changeColor(colors, bold, bg);
                return ReferenceEquals(__ret, null) ? global::System.IntPtr.Zero : __ret.__Instance;
            }
        ...
        public unsafe partial class raw_string_ostream : llvm.raw_ostream, IDisposable
        {
            ...
            {
                var ret = (raw_string_ostream.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (raw_string_ostream) _References[instance].Target;
                target.DestroyNativeInstance();
            }
        ...
        public unsafe partial class raw_svector_ostream : llvm.raw_ostream, IDisposable
        {
            ...
            {
                var ret = (raw_svector_ostream.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (raw_svector_ostream) _References[instance].Target;
                target.DestroyNativeInstance();
            }
        ...
        public unsafe partial class raw_null_ostream : llvm.raw_ostream, IDisposable
        {
            ...
            {
                var ret = (raw_null_ostream.Internal*) Marshal.AllocHGlobal(20);
                *ret = native;
                return ret;
            }
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (raw_null_ostream) _References[instance].Target;
                target.DestroyNativeInstance();
            }
        ...
        internal unsafe partial class raw_ostreamInternal : llvm.raw_ostream, IDisposable
        {
            ...
            {
                var ret = (raw_ostream.Internal*) Marshal.AllocHGlobal(20);
                *ret = native;
                return ret;
            }
