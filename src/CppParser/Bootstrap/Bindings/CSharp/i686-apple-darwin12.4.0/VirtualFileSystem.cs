    ...
    namespace clang
    {
        ...
        namespace vfs
        {
            ...
            public unsafe partial class Status : IDisposable
            {
                ...
                {
                    var ret = (Status.Internal*) Marshal.AllocHGlobal(68);
                    *ret = native;
                    return ret;
                }
            ...
            public unsafe abstract partial class File : IDisposable
            {
                ...
                private static void _dtor_0DelegateHook(global::System.IntPtr instance)
                {
                    ...
                    var target = (File) _References[instance].Target;
                ...
                private static void _setName_0DelegateHook(global::System.IntPtr instance, llvm.StringRef.Internal Name)
                {
                    ...
                    var target = (File) _References[instance].Target;
                    target.setName(llvm.StringRef.__CreateInstance(Name));
                }
            ...
            public unsafe partial class directory_iterator : IDisposable
            {
                ...
                {
                    var ret = (directory_iterator.Internal*) Marshal.AllocHGlobal(8);
                    *ret = native;
                    return ret;
                }
            ...
            public unsafe partial class recursive_directory_iterator : IDisposable
            {
                ...
                {
                    var ret = (recursive_directory_iterator.Internal*) Marshal.AllocHGlobal(12);
                    *ret = native;
                    return ret;
                }
            ...
            public unsafe abstract partial class FileSystem : IDisposable
            {
                ...
                private static void _dtor_0DelegateHook(global::System.IntPtr instance)
                {
                    ...
                    var target = (FileSystem) _References[instance].Target;
                    target.DestroyNativeInstance();
                }
                ...
                private static clang.vfs.directory_iterator.Internal _dir_begin_0DelegateHook(global::System.IntPtr instance, global::System.IntPtr @return, global::System.IntPtr Dir, global::System.IntPtr EC)
                {
                    ...
                    var __ret = target.dir_begin(__result1, __result2);
            ...
            public unsafe partial class OverlayFileSystem : clang.vfs.FileSystem, IDisposable
            {
                ...
                {
                    var ret = (OverlayFileSystem.Internal*) Marshal.AllocHGlobal(28);
                    *ret = native;
                    return ret;
                }
                ...
                private static void _dtor_0DelegateHook(global::System.IntPtr instance)
                {
                    ...
                    var target = (OverlayFileSystem) _References[instance].Target;
                    target.DestroyNativeInstance();
                }
            ...
            public unsafe partial class YAMLVFSEntry : IDisposable
            {
                ...
                {
                    var ret = (YAMLVFSEntry.Internal*) Marshal.AllocHGlobal(24);
                    *ret = native;
                    return ret;
                }
            ...
            public unsafe partial class YAMLVFSWriter : IDisposable
            {
                ...
                {
                    var ret = (YAMLVFSWriter.Internal*) Marshal.AllocHGlobal(16);
                    *ret = native;
                    return ret;
                }
            ...
            internal unsafe partial class FileInternal : clang.vfs.File, IDisposable
            {
                ...
                {
                    var ret = (File.Internal*) Marshal.AllocHGlobal(4);
                    *ret = native;
                    return ret;
                }
                ...
                {
                    void* slot = *(void**) (((File.Internal*) __Instance)->vfptr0 + 4 * 4);
                ...
                {
                    void* slot = *(void**) (((File.Internal*) __Instance)->vfptr0 + 5 * 4);
            ...
            internal unsafe partial class FileSystemInternal : clang.vfs.FileSystem, IDisposable
            {
                ...
                {
                    var ret = (FileSystem.Internal*) Marshal.AllocHGlobal(8);
                    *ret = native;
                    return ret;
                }
                ...
                public virtual clang.vfs.directory_iterator dir_begin(llvm.Twine Dir, std.__1.error_code EC)
                {
                    void* slot = *(void**) (((FileSystem.Internal*) __Instance)->vfptr0 + 4 * 4);
            ...
            public unsafe partial class VirtualFileSystem
            {
                public partial struct Internal
                {
                    ...
                    internal static extern void getNextVirtualUniqueID_0(global::System.IntPtr @return);
                }
                ...
                {
                    var __ret = new llvm.sys.fs.UniqueID.Internal();
                    Internal.getNextVirtualUniqueID_0(new IntPtr(&__ret));
                    return llvm.sys.fs.UniqueID.__CreateInstance(__ret);
                }
            }
            ...
            namespace detail
            {
                ...
                public unsafe abstract partial class DirIterImpl : IDisposable
                {
                    ...
                    private static void _dtor_0DelegateHook(global::System.IntPtr instance)
                    {
                        ...
                        var target = (DirIterImpl) _References[instance].Target;
                        target.DestroyNativeInstance();
                    }
                ...
                internal unsafe partial class DirIterImplInternal : clang.vfs.detail.DirIterImpl, IDisposable
                {
                    ...
                    {
                        var ret = (DirIterImpl.Internal*) Marshal.AllocHGlobal(72);
                        *ret = native;
                        return ret;
                    }
                    ...
                    {
                        void* slot = *(void**) (((DirIterImpl.Internal*) __Instance)->vfptr0 + 2 * 4);
