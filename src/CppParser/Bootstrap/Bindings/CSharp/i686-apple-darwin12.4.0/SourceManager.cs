    ...
    namespace clang
    {
        ...
        public unsafe abstract partial class ExternalSLocEntrySource : IDisposable
        {
            ...
            private static void _dtor_0DelegateHook(global::System.IntPtr instance)
            {
                ...
                var target = (ExternalSLocEntrySource) _References[instance].Target;
            ...
            private static bool _ReadSLocEntry_0DelegateHook(global::System.IntPtr instance, int ID)
            {
                ...
                var target = (ExternalSLocEntrySource) _References[instance].Target;
                var __ret = target.ReadSLocEntry(ID);
                return __ret;
            }
        ...
        public unsafe partial class SourceManager : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern uint getContentCacheSize_0(global::System.IntPtr instance);
                ...
                internal static extern uint getDataStructureSizes_0(global::System.IntPtr instance);
            ...
            {
                var ret = (SourceManager.Internal*) Marshal.AllocHGlobal(376);
                *ret = native;
                return ret;
            }
            ...
            /// </remarks>
            public uint getContentCacheSize()
            {
            ...
            /// </remarks>
            public uint getDataStructureSizes()
            {
        ...
        internal unsafe partial class ExternalSLocEntrySourceInternal : clang.ExternalSLocEntrySource, IDisposable
        {
            ...
            {
                var ret = (ExternalSLocEntrySource.Internal*) Marshal.AllocHGlobal(4);
                *ret = native;
                return ret;
            }
            ...
            {
                void* slot = *(void**) (((ExternalSLocEntrySource.Internal*) __Instance)->vfptr0 + 2 * 4);
        ...
        namespace SrcMgr
        {
            ...
            public unsafe partial class ContentCache : IDisposable
            {
                ...
                {
                    var ret = (ContentCache.Internal*) Marshal.AllocHGlobal(32);
                    *ret = native;
                    return ret;
                }
            ...
            public unsafe partial class FileInfo : IDisposable
            {
                ...
                public partial struct Internal
                {
                    ...
                    internal static extern void get_0(global::System.IntPtr @return, clang.SourceLocation.Internal IL, global::System.IntPtr Con, clang.SrcMgr.CharacteristicKind FileCharacter);
                ...
                {
                    var ret = (FileInfo.Internal*) Marshal.AllocHGlobal(12);
                    *ret = native;
                    return ret;
                }
                ...
                public static clang.SrcMgr.FileInfo get(clang.SourceLocation IL, clang.SrcMgr.ContentCache Con, clang.SrcMgr.CharacteristicKind FileCharacter)
                {
                    ...
                    var arg2 = FileCharacter;
                    var __ret = new clang.SrcMgr.FileInfo.Internal();
                    Internal.get_0(new IntPtr(&__ret), arg0, arg1, arg2);
            ...
            public unsafe partial class ExpansionInfo : IDisposable
            {
                ...
                public partial struct Internal
                {
                    ...
                    internal static extern void create_0(global::System.IntPtr @return, clang.SourceLocation.Internal SpellingLoc, clang.SourceLocation.Internal Start, clang.SourceLocation.Internal End);

                    [SuppressUnmanagedCodeSecurity]
                    [DllImport("CppSharp", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
                        EntryPoint="_ZN5clang6SrcMgr13ExpansionInfo17createForMacroArgENS_14SourceLocationES2_")]
                    internal static extern void createForMacroArg_0(global::System.IntPtr @return, clang.SourceLocation.Internal SpellingLoc, clang.SourceLocation.Internal ExpansionLoc);
                }
                ...
                public static clang.SrcMgr.ExpansionInfo create(clang.SourceLocation SpellingLoc, clang.SourceLocation Start, clang.SourceLocation End)
                {
                    ...
                    var __ret = new clang.SrcMgr.ExpansionInfo.Internal();
                    Internal.create_0(new IntPtr(&__ret), arg0, arg1, arg2);
                ...
                public static clang.SrcMgr.ExpansionInfo createForMacroArg(clang.SourceLocation SpellingLoc, clang.SourceLocation ExpansionLoc)
                {
                    ...
                    var arg1 = ReferenceEquals(ExpansionLoc, null) ? new clang.SourceLocation.Internal() : *(clang.SourceLocation.Internal*) (ExpansionLoc.__Instance);
                    var __ret = new clang.SrcMgr.ExpansionInfo.Internal();
                    Internal.createForMacroArg_0(new IntPtr(&__ret), arg0, arg1);
                    return clang.SrcMgr.ExpansionInfo.__CreateInstance(__ret);
                }
            }
            ...
            public unsafe partial class SLocEntry : IDisposable
            {
                ...
                {
                    var ret = (SLocEntry.Internal*) Marshal.AllocHGlobal(16);
                    *ret = native;
                    return ret;
                }
