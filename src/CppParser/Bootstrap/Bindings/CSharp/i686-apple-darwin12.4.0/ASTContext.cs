...
namespace CppSharp
{
    ...
    namespace clang
    {
        ...
        {
            [StructLayout(LayoutKind.Explicit, Size = 10620)]
            public partial struct Internal
            {
                [FieldOffset(4)]
                ...
                internal static extern global::System.IntPtr Allocate_0(global::System.IntPtr instance, uint Size, uint Align);
                ...
                internal static extern uint getASTAllocatedMemory_0(global::System.IntPtr instance);

                [SuppressUnmanagedCodeSecurity]
                [DllImport("CppSharp", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
                    EntryPoint="_ZNK5clang10ASTContext27getSideTableAllocatedMemoryEv")]
                internal static extern uint getSideTableAllocatedMemory_0(global::System.IntPtr instance);
                ...
                internal static extern void getTypeInfo_0(global::System.IntPtr @return, global::System.IntPtr instance, global::System.IntPtr T);

                [SuppressUnmanagedCodeSecurity]
                [DllImport("CppSharp", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
                    EntryPoint="_ZNK5clang10ASTContext11getTypeInfoENS_8QualTypeE")]
                internal static extern void getTypeInfo_1(global::System.IntPtr @return, global::System.IntPtr instance, clang.QualType.Internal T);
            ...
            public unsafe partial class RawCommentAndCacheFlags : IDisposable
            {
                ...
                {
                    var ret = (RawCommentAndCacheFlags.Internal*) Marshal.AllocHGlobal(8);
                    *ret = native;
                    return ret;
                }
            ...
            public unsafe partial class SectionInfo : IDisposable
            {
                ...
                {
                    var ret = (SectionInfo.Internal*) Marshal.AllocHGlobal(12);
                    *ret = native;
                    return ret;
                }
            ...
            {
                var ret = (ASTContext.Internal*) Marshal.AllocHGlobal(10620);
                *ret = native;
                return ret;
            }
            ...
            public global::System.IntPtr Allocate(uint Size, uint Align)
            {
                var arg0 = Size;
            ...
            /// </remarks>
            public uint getASTAllocatedMemory()
            {
            ...
            /// <para>/// Return the total memory used for various side tables.</para>
            /// </remarks>
            public uint getSideTableAllocatedMemory()
            {
            ...
            {
                var arg0 = ReferenceEquals(T, null) ? global::System.IntPtr.Zero : T.__Instance;
                var __ret = new clang.TypeInfo.Internal();
                Internal.getTypeInfo_0(new IntPtr(&__ret), __Instance, arg0);
            ...
            public clang.TypeInfo getTypeInfo(clang.QualType T)
            {
                var arg0 = ReferenceEquals(T, null) ? new clang.QualType.Internal() : *(clang.QualType.Internal*) (T.__Instance);
                var __ret = new clang.TypeInfo.Internal();
                Internal.getTypeInfo_1(new IntPtr(&__ret), __Instance, arg0);
                return clang.TypeInfo.__CreateInstance(__ret);
            }
