    ...
    namespace CppSharp
    {
        namespace CppParser
        {
            ...
            public unsafe partial class ParserOptions : IDisposable
            {
                ...
                {
                    var ret = (ParserOptions.Internal*) Marshal.AllocHGlobal(224);
                    *ret = native;
                    return ret;
                }
            ...
            public unsafe partial class ParserDiagnostic : IDisposable
            {
                ...
                {
                    var ret = (ParserDiagnostic.Internal*) Marshal.AllocHGlobal(64);
                    *ret = native;
                    return ret;
                }
            ...
            public unsafe partial class ParserResult : IDisposable
            {
                ...
                {
                    var ret = (ParserResult.Internal*) Marshal.AllocHGlobal(56);
                    *ret = native;
                    return ret;
                }
