    ...
    namespace clang
    {
        ...
        public unsafe partial class ExternalASTSource : IDisposable
        {
            ...
            public unsafe partial class Deserializing : IDisposable
            {
                ...
                {
                    var ret = (Deserializing.Internal*) Marshal.AllocHGlobal(8);
                    *ret = native;
                    return ret;
                }
            ...
            {
                var ret = (ExternalASTSource.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
            ...
            void SetupVTables(global::System.IntPtr instance)
            {
                ...
                if (_NewVTables == null)
                {
                    ...
                    var vfptr0 = Marshal.AllocHGlobal(22 * 8);
                    ...
                    *(void**)(vfptr0 + 104) = _Thunks[8];
                    *(void**)(vfptr0 + 112) = _Thunks[9];
                    *(void**)(vfptr0 + 120) = *(void**)(native->vfptr0 + 120);
                    *(void**)(vfptr0 + 128) = _Thunks[10];
                    *(void**)(vfptr0 + 136) = _Thunks[11];
                    *(void**)(vfptr0 + 144) = _Thunks[12];
                    *(void**)(vfptr0 + 152) = *(void**)(native->vfptr0 + 152);
                    *(void**)(vfptr0 + 160) = _Thunks[13];
                    *(void**)(vfptr0 + 168) = *(void**)(native->vfptr0 + 168);
                    *(void**)(vfptr0 + 176) = _Thunks[14];
                }
