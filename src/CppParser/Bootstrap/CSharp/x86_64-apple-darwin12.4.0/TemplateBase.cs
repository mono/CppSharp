...
namespace CppSharp
{
    namespace clang
    {
        ...
        public unsafe partial class TemplateArgument : IDisposable
        {
            ...
            {
                var ret = (TemplateArgument.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class TemplateArgumentLocInfo : IDisposable
        {
            ...
            {
                var ret = (TemplateArgumentLocInfo.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class TemplateArgumentLoc : IDisposable
        {
            ...
            {
                var ret = (TemplateArgumentLoc.Internal*) Marshal.AllocHGlobal(48);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class TemplateArgumentListInfo : IDisposable
        {
            ...
            {
                var ret = (TemplateArgumentListInfo.Internal*) Marshal.AllocHGlobal(416);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class ASTTemplateArgumentListInfo : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern ulong sizeFor_0(uint NumTemplateArgs);
            ...
            {
                var ret = (ASTTemplateArgumentListInfo.Internal*) Marshal.AllocHGlobal(16);
                *ret = native;
                return ret;
            }
            ...
            public static ulong sizeFor(uint NumTemplateArgs)
            {
        ...
        public unsafe partial class ASTTemplateKWAndArgsInfo : clang.ASTTemplateArgumentListInfo, IDisposable
        {
            ...
            {
                var ret = (ASTTemplateKWAndArgsInfo.Internal*) Marshal.AllocHGlobal(16);
                *ret = native;
                return ret;
            }
