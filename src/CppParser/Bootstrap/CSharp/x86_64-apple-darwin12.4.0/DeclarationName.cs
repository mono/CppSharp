    ...
    namespace clang
    {
        ...
        public unsafe partial class DeclarationName : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern ulong getAsOpaqueInteger_0(global::System.IntPtr instance);
                ...
                internal static extern clang.DeclarationName.Internal getFromOpaqueInteger_0(ulong P);
            ...
            {
                var ret = (DeclarationName.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
            ...
            /// </remarks>
            public ulong getAsOpaqueInteger()
            {
            ...
            public static clang.DeclarationName getFromOpaqueInteger(ulong P)
            {
                var arg0 = P;
        ...
        public unsafe partial class DeclarationNameTable : IDisposable
        {
            ...
            {
                var ret = (DeclarationNameTable.Internal*) Marshal.AllocHGlobal(32);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class DeclarationNameLoc : IDisposable
        {
            ...
            public unsafe partial class NT : IDisposable
            {
                ...
                {
                    var ret = (NT.Internal*) Marshal.AllocHGlobal(8);
                    *ret = native;
                    return ret;
                }
        ...
        public unsafe partial class DeclarationNameInfo : IDisposable
        {
            ...
            {
                var ret = (DeclarationNameInfo.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
