...
namespace CppSharp
{
    namespace clang
    {
        ...
        public unsafe partial class NestedNameSpecifier : llvm.FoldingSetImpl.Node, IDisposable
        {
            ...
            {
                var ret = (NestedNameSpecifier.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class NestedNameSpecifierLoc : IDisposable
        {
            ...
            {
                var ret = (NestedNameSpecifierLoc.Internal*) Marshal.AllocHGlobal(16);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class NestedNameSpecifierLocBuilder : IDisposable
        {
            ...
            {
                var ret = (NestedNameSpecifierLocBuilder.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
