    ...
    namespace clang
    {
        public unsafe partial class PartialDiagnostic : IDisposable
        {
            ...
            public unsafe partial class Storage : IDisposable
            {
                ...
                {
                    var ret = (Storage.Internal*) Marshal.AllocHGlobal(816);
                    *ret = native;
                    return ret;
                }
                ...
                public Storage()
                {
                    __Instance = Marshal.AllocHGlobal(816);
                    __ownsNativeInstance = true;
                    NativeToManagedMap[__Instance] = this;
            ...
            {
                [StructLayout(LayoutKind.Explicit, Size = 13192)]
                public partial struct Internal
                {
                    [FieldOffset(0)]
                    public fixed byte Cached[13056];
                ...
                {
                    var ret = (StorageAllocator.Internal*) Marshal.AllocHGlobal(13192);
                    *ret = native;
                    return ret;
                }
                ...
                {
                    __Instance = Marshal.AllocHGlobal(13192);
                    __ownsNativeInstance = true;
                    NativeToManagedMap[__Instance] = this;
                    Internal.ctor_0(__Instance);
                }
            ...
            {
                var ret = (PartialDiagnostic.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
