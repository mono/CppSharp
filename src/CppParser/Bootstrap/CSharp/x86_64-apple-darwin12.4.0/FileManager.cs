...
namespace CppSharp
{
    namespace clang
    {
        ...
        public unsafe partial class DirectoryEntry : IDisposable
        {
            ...
            {
                var ret = (DirectoryEntry.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class FileEntry : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern long getModificationTime_0(global::System.IntPtr instance);
            ...
            {
                var ret = (FileEntry.Internal*) Marshal.AllocHGlobal(72);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class FileManager : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern global::System.IntPtr getVirtualFile_0(global::System.IntPtr instance, llvm.StringRef.Internal Filename, long Size, long ModificationTime);
                ...
                internal static extern void modifyFileEntry_0(global::System.IntPtr File, long Size, long ModificationTime);
            ...
            {
                var ret = (FileManager.Internal*) Marshal.AllocHGlobal(712);
                *ret = native;
                return ret;
            }
            ...
            /// </remarks>
            public clang.FileEntry getVirtualFile(llvm.StringRef Filename, long Size, long ModificationTime)
            {
                var arg0 = ReferenceEquals(Filename, null) ? new llvm.StringRef.Internal() : *(llvm.StringRef.Internal*) (Filename.__Instance);
                var arg1 = Size;
            ...
            /// </remarks>
            public static void modifyFileEntry(clang.FileEntry File, long Size, long ModificationTime)
            {
