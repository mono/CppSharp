            ...
            namespace fs
            {
                ...
                public unsafe partial class file_status : IDisposable
                {
                    ...
                    public partial struct Internal
                    {
                        ...
                        internal static extern void ctor_2(global::System.IntPtr instance, llvm.sys.fs.file_type Type, llvm.sys.fs.perms Perms, int Dev, ulong Ino, long MTime, uint UID, uint GID, long Size);
                    ...
                    {
                        var ret = (file_status.Internal*) Marshal.AllocHGlobal(48);
                        *ret = native;
                        return ret;
                    }
                    ...
                    public file_status(llvm.sys.fs.file_type Type, llvm.sys.fs.perms Perms, int Dev, ulong Ino, long MTime, uint UID, uint GID, long Size)
                    {
                        __Instance = Marshal.AllocHGlobal(48);
                        __ownsNativeInstance = true;
                        NativeToManagedMap[__Instance] = this;
                ...
                public unsafe partial class mapped_file_region : IDisposable
                {
                    ...
                    {
                        var ret = (mapped_file_region.Internal*) Marshal.AllocHGlobal(16);
                        *ret = native;
                        return ret;
                    }
                ...
                public unsafe partial class directory_entry : IDisposable
                {
                    ...
                    {
                        var ret = (directory_entry.Internal*) Marshal.AllocHGlobal(72);
                        *ret = native;
                        return ret;
                    }
                ...
                public unsafe partial class recursive_directory_iterator : IDisposable
                {
                    ...
                    {
                        var ret = (recursive_directory_iterator.Internal*) Marshal.AllocHGlobal(8);
                        *ret = native;
                        return ret;
                    }
                ...
                namespace detail
                {
                    ...
                    public unsafe partial class DirIterState : IDisposable
                    {
                        ...
                        {
                            var ret = (DirIterState.Internal*) Marshal.AllocHGlobal(88);
                            *ret = native;
                            return ret;
                        }
                    ...
                    public unsafe partial class RecDirIterState : IDisposable
                    {
                        ...
                        {
                            var ret = (RecDirIterState.Internal*) Marshal.AllocHGlobal(40);
                            *ret = native;
                            return ret;
                        }
