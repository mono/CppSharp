...
namespace CppSharp
{
    namespace llvm
    {
        ...
        public unsafe partial class MemoryBufferRef : IDisposable
        {
            ...
            {
                var ret = (MemoryBufferRef.Internal*) Marshal.AllocHGlobal(32);
                *ret = native;
                return ret;
            }
        ...
        internal unsafe partial class MemoryBufferInternal : llvm.MemoryBuffer, IDisposable
        {
            ...
            {
                var ret = (MemoryBuffer.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
            ...
            {
                void* slot = *(void**) (((MemoryBuffer.Internal*) __Instance)->vfptr0 + 3 * 8);
