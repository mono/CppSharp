...
namespace CppSharp
{
    namespace clang
    {
        ...
        public unsafe partial class IdentifierInfo : IDisposable
        {
            ...
            {
                var ret = (IdentifierInfo.Internal*) Marshal.AllocHGlobal(24);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class PoisonIdentifierRAIIObject : IDisposable
        {
            ...
            {
                var ret = (PoisonIdentifierRAIIObject.Internal*) Marshal.AllocHGlobal(16);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class IdentifierTable : IDisposable
        {
            ...
            {
                var ret = (IdentifierTable.Internal*) Marshal.AllocHGlobal(168);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class Selector : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern void ctor_3(global::System.IntPtr instance, ulong V);
            ...
            {
                var ret = (Selector.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
        ...
        public unsafe partial class SelectorTable : IDisposable
        {
            ...
            public partial struct Internal
            {
                ...
                internal static extern ulong getTotalMemory_0(global::System.IntPtr instance);
            ...
            {
                var ret = (SelectorTable.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
        ...
        internal unsafe partial class IdentifierIteratorInternal : clang.IdentifierIterator, IDisposable
        {
            ...
            {
                var ret = (IdentifierIterator.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
            ...
            {
                void* slot = *(void**) (((IdentifierIterator.Internal*) __Instance)->vfptr0 + 2 * 8);
        ...
        internal unsafe partial class IdentifierInfoLookupInternal : clang.IdentifierInfoLookup, IDisposable
        {
            ...
            {
                var ret = (IdentifierInfoLookup.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
            ...
            {
                void* slot = *(void**) (((IdentifierInfoLookup.Internal*) __Instance)->vfptr0 + 2 * 8);
        ...
        internal unsafe partial class ExternalIdentifierLookupInternal : clang.ExternalIdentifierLookup, IDisposable
        {
            ...
            {
                var ret = (ExternalIdentifierLookup.Internal*) Marshal.AllocHGlobal(8);
                *ret = native;
                return ret;
            }
            ...
            {
                void* slot = *(void**) (((ExternalIdentifierLookup.Internal*) __Instance)->vfptr0 + 2 * 8);
